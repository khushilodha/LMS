...
class studentDeailsWindow:
    ...
    def create_window(self, mainloop):
        ...
        self._win.geometry(f"{self.width}x{self.height}+{self.screen_width}+{self.screen_height}")
        ...
        self.top_label = Label(self._win, image=self.photo0, bg="#40E0D0")
        self.top_label.place(x=0, y=0, width=600, height=65)

        self.del_button = Button(self._win, text="Delete", font=("Nirmala UI", 15, 'bold'), bg="gold",
    ...
    def showtree(self):
        ...
        self.treev = ttk.Treeview(self.frame, selectmode="browse", xscrollcommand=self.horscr.set, yscrollcommand=self.verscr.set)
        ...
        self.treev.heading(3, text="Gender")
        self.treev.heading(4, text="Contact")
        self.treev.heading(5, text="Date Of Birth")
        self.treev.heading(6, text="Address")
    ...
    def get_image(self, ev):
        ...
        try:
            ...
            cursor.execute(f"select user_image from student where user_email = '{self.info[0]}'")
    ...
    def delete_student(self):
        ...
        if self.isselected == True:
            ...
            cursor.execute(f"delete from student where user_email = '{self.info[0]}'")
            connection.commit()
            connection.close()
            self.isselected = False
